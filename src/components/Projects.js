...
const Projects = () => {
  return (
 <div className='flex flex-col mt-44 pt-4' id='projects'>
  ...
  <div className='flex md:flex-row flex-col justify-center items-center flex-wrap mt-24'>
    <div className='flex flex-col md:hover:border-white border-2 md:border-[#171c28]  rounded-2xl w-80 md:w-96 md:mx-12 hover:shadow-lg hover:shadow-white md:hover:w-1/4  items-center justify-center '>
    ...
    <div className='flex text-white p-2 bg-[#55198B] w-28 justify-center items-center mb-6 mt-4 hover:bg-white hover:text-[#55198B] rounded-xl'>Know more</div>
    </div>

    <div className='flex flex-col md:hover:border-white border-2 rounded-2xl md:border-[#171c28] w-80 md:w-96 hover:shadow-lg hover:shadow-white md:mx-12 md:mt-0 mt-12 items-center '>
     <img src={u}  alt="crypto" className='flex rounded-t-2xl'></img>
     <div className='flex justify-center text-white text-4xl font-bold mt-8 font-mono'>Crypto Dapp</div>
     <div className='flex justify-center text-center text-slate-400 md:text-xl text-md mt-6 px-4 font-mono'>A decentralised blockchain based application used to transfer ether from one account to another</div>
    <div className='flex text-white p-2 bg-[#55198B] w-28 justify-center items-center mb-6 mt-4 hover:bg-white hover:text-[#55198B] rounded-xl'>Know more</div>
    </div>

    <div className='flex flex-col md:hover:border-white border-2 rounded-2xl  md:border-[#171c28] w-80 md:w-96  md:mx-12 hover:shadow-lg hover:shadow-white md:mt-0 mt-12 items-center '>
