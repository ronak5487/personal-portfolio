...
const Greetings = () => {
  const style={
    ...
    button1:'bg-[#55198B] md:w-40 w-36 hover:text-[#55198B] mt-14 hover:bg-white hover:mt-14 h-12 rounded-md justify-center items-center text-center font-semibold font-mono hover:mt-12 text-white md:text-xl text-lg p-2 ',
  ...
  return (
    <div className='flex md:flex-row  flex-col md:items-center '>
        ...
        <div className='justify-center items-center md:mt-32 mt-28 md:w-1/3 md:pl-12 px-4'>
